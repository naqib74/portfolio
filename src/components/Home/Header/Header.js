        ...
        <section>
            ...
            <div className='row mt-5'>
                <div className="col-md-5 col-sm-6 col-12 offset-md-1 text-white">
                    ...
                    <h4><Typewriter
                        options={{
                            strings: ['MERN Stack Developer', 'Engineer','Programmer'],
                            autoStart: true,
                            loop: true,
                        }}
                    /></h4>
                    ...
                    <a href="https://github.com/naqib74" target='_blank'> <GitHubIcon style={{ fontSize: '30px' }} /></a>
                    ...
                    <br />
                    <a style={{backgroundColor:'#FC1056',color:'white'}} className='btn mt-3' href="https://drive.google.com/uc?export=download&id=1yuL2Mr7tkxqGRJBNKjeYf6LLPe0p2G3l" target='_blink'><CloudDownloadIcon style={{ fontSize: '25px' }} /> Download Resume</a>
