        ...
        <section style={{backgroundColor:'#0A192F', height:'100%'}}>
            ...
            <div className="row mt-5">
                ...
                <h1 style={{borderBottom:'3px solid gray',width:'60%'}}>Doctor's Portal</h1>
                    ...
                    <a style={{marginRight:'30px'}} className='btn btn-primary' href="https://doctors-portal-27cde.web.app/" target='_blink'>Website</a>
                    <a className='btn btn-primary' href="https://github.com/naqib74/doctors-portal" target='_blink'>source code</a>
